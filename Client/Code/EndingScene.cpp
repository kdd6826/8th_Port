...
HRESULT Client::CEndingScene::Add_Component(void)
{
	...
	// texture
	pComponent = m_pTextureCom = dynamic_cast<Engine::CTexture*>(Engine::Clone(Engine::RESOURCE_STAGE, L"Texture_EndingScene"));
	NULL_CHECK_RETURN(pComponent, E_FAIL);
...
HRESULT CEndingScene::SetUp_ConstantTable(LPD3DXEFFECT& pEffect)
{
...
HRESULT Client::CEndingScene::Ready_Object(void)
{
...
Client::_int Client::CEndingScene::Update_Object(const _float& fTimeDelta)
{
	//if (!isFadeIn)
	//{
	//	if (m_fAlpha < 1.f)
...
void Client::CEndingScene::Render_Object(void)
{
	D3DXMatrixOrthoLH(&m_matProj, WINCX, WINCY, 0.f, 1.f);
