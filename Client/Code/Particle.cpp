...
HRESULT Client::CParticle::Add_Component(void)
{
	Engine::CComponent*		pComponent = nullptr;

	// buffer
	pComponent = m_pBufferCom = dynamic_cast<Engine::CPtTex*>(Engine::Clone(Engine::RESOURCE_STATIC, L"Buffer_PtTex"));
...
HRESULT Client::CParticle::Ready_Object(void)
{
...
Client::_int Client::CParticle::Update_Object(const _float& fTimeDelta)
{
...
void Client::CParticle::Render_Object(void)
{
