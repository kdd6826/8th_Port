...
{
	// DEBUG ¿ë
	Engine::Render_Font(L"Font_Jinji", m_pLoading->Get_LoadString(), &_vec2(950, 10.f), D3DXCOLOR(1.f, 1.f, 1.f, 1.f));
...
HRESULT Client::CLogo::Ready_Resource(Engine::RESOURCETYPE eType)
{
	...
	FAILED_CHECK_RETURN(Engine::Ready_Buffer(m_pGraphicDev, Engine::RESOURCE_STATIC, L"Buffer_RealTrail", Engine::BUFFER_TRAIL,8), E_FAIL);
