#ifndef DashGuard_h__
#define DashGuard_h__
...
BEGIN(Client)
class CDashGuard : public CMonster
{
private:
	explicit CDashGuard(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CDashGuard(void);
...
private:
	...
	_float						m_fScale = 0.f;
public:
	static CDashGuard*	Create(LPDIRECT3DDEVICE9 pGraphicDev);
