...
CConfusionHole::CConfusionHole(LPDIRECT3DDEVICE9 pGraphicDev)
	: Engine::CGameObject(pGraphicDev)
{

}

CConfusionHole::~CConfusionHole(void)
{
...
HRESULT Client::CConfusionHole::Add_Component(void)
{
...
HRESULT CConfusionHole::SetUp_ConstantTable(LPD3DXEFFECT & pEffect)
{
...
CConfusionHole* CConfusionHole::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CConfusionHole*	pInstance = new CConfusionHole(pGraphicDev);
...
void Client::CConfusionHole::Render_Object(void)
{
