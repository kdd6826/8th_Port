...
HRESULT CManagement::Ready_Shader(LPDIRECT3DDEVICE9 & pGraphicDev)
{
	...
	// Shade
	pShader = CShader::Create(pGraphicDev, L"../../Reference/Header/Shader_PlayerMesh.hpp");
	NULL_CHECK_RETURN(pShader, E_FAIL);
	FAILED_CHECK_RETURN(Ready_Proto(L"Proto_Shader_PlayerMesh", pShader), E_FAIL);

	// Shade
	pShader = CShader::Create(pGraphicDev, L"../../Reference/Header/Shader_MonsterMesh.hpp");
	NULL_CHECK_RETURN(pShader, E_FAIL);
	FAILED_CHECK_RETURN(Ready_Proto(L"Proto_Shader_MonsterMesh", pShader), E_FAIL);
	...
	// Effect
	pShader = CShader::Create(pGraphicDev, L"../../Reference/Header/Shader_FadeInOutTransform.hpp");
	NULL_CHECK_RETURN(pShader, E_FAIL);
	FAILED_CHECK_RETURN(Ready_Proto(L"Proto_Shader_FadeInOutTransform", pShader), E_FAIL);
	...
	//// Effect
	//pShader = CShader::Create(pGraphicDev, L"../../Reference/Header/Shader_GateEffect.hpp");
	//NULL_CHECK_RETURN(pShader, E_FAIL);
	//FAILED_CHECK_RETURN(Ready_Proto(L"Proto_Shader_GateEffect", pShader), E_FAIL);

	// Effect
	pShader = CShader::Create(pGraphicDev, L"../../Reference/Header/Shader_Effect2.hpp");
	NULL_CHECK_RETURN(pShader, E_FAIL);
	FAILED_CHECK_RETURN(Ready_Proto(L"Proto_Shader_Effect2", pShader), E_FAIL);

	// Effect
	pShader = CShader::Create(pGraphicDev, L"../../Reference/Header/Shader_Gate.hpp");
	NULL_CHECK_RETURN(pShader, E_FAIL);
	FAILED_CHECK_RETURN(Ready_Proto(L"Proto_Shader_Gate", pShader), E_FAIL);
	// Effect
	pShader = CShader::Create(pGraphicDev, L"../../Reference/Header/Shader_Skill.hpp");
	NULL_CHECK_RETURN(pShader, E_FAIL);
	FAILED_CHECK_RETURN(Ready_Proto(L"Proto_Shader_Skill", pShader), E_FAIL);
