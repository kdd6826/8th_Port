...
HRESULT CStage::Ready_Environment_Layer(const wchar_t* pLayerTag)
{
...
HRESULT CStage::Ready_GameLogic_Layer(const wchar_t* pLayerTag)
{
	Engine::CLayer*			pLayer = Engine::CLayer::Create();
	NULL_CHECK_RETURN(pLayer, E_FAIL);
...
HRESULT CStage::Ready_UI_Layer(const wchar_t* pLayerTag)
{
	return S_OK;
}

HRESULT CStage::Ready_Resource(Engine::RESOURCETYPE eType)
{
