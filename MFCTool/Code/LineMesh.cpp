...
CLineMesh::CLineMesh(LPDIRECT3DDEVICE9 pGraphicDev)
	: Engine::CGameObject(pGraphicDev)
{
	
}

CLineMesh::~CLineMesh(void)
{

}

//Engine::_vec3 CLineMesh::PickUp_OnTerrain(void)
//{
...
HRESULT CLineMesh::Add_Component(void)
{
...
CLineMesh* CLineMesh::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CLineMesh* pInstance = new CLineMesh(pGraphicDev);
...
HRESULT CLineMesh::Ready_Object(void)
{
...
_int CLineMesh::Update_Object(const _float& fTimeDelta)
{
...
void CLineMesh::Render_Object(void)
{
...
//void CLineMesh::SetUp_OnTerrain(void)
//{
//	_vec3	vPosition;
