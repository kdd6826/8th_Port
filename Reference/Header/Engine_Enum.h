...
namespace Engine
{
	...
	enum BUFFERID { BUFFER_TRICOL, BUFFER_RCTEX, BUFFER_TERRAINTEX, BUFFER_CUBETEX, BUFFER_SPHERE, BUFFER_COLLSPHERE, BUFFER_OBJSPHERE,  BUFFER_PTTEX, BUFFER_INRCTEX };
